...
> *「所谓的熬夜，是为了追求未曾见过的自由与心动。」——《彻夜之歌》*

本项目名称 **Nazuna（七草 荠 / 七草 ナズナ）** 取自漫画/动画作品 **《彻夜之歌》（よふかしのうた / Call of the Night）** 的女主角。

### 🌟 名字背后的博弈美学：
1. **「彻夜对局 · 纯粹博弈」**：正如故事中唯有在夜幕降临、万籁俱寂之时，灵魂才能脱离白昼的喧嚣；在深夜中展开一场纯粹、专注的人机棋盘智斗，正是棋手最沉浸的心智修行。
2. **「暗夜黑曜 · 月光白玉」**：棋盘上的黑子如暗夜般深邃莫测，白子若月华般清冽纯澈。二者在 15×15 的棋盘空间中交织碰撞，恰似黑夜与月色的优雅对舞。
3. **「夜之敏锐 · 毫秒绝杀」**：宛如吸血鬼在黑夜中敏锐超常的直觉与洞察力，引擎的 **VCF / VCT 威胁空间算杀** 能在数毫秒内穿透棋盘迷雾，于纷繁复杂的残局中瞬间锁定连续叫杀胜机。
4. **「自由意志 · 秩序之美」**：既能在严苛的国际连珠禁手裁判下化解危机，亦能在自由模式中如夜风般肆意游走。
